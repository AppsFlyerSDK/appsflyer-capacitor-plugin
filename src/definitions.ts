...
export interface AppsFlyerPlugin {
    ...
    */
     ...
     * @param additionalParameters: optional map containing non-mandatory parameters. 
     */
    logAdRevenue(adRevenueData: AFAdRevenueData, additionalParameters?: Map<string, any>): Promise<void>
