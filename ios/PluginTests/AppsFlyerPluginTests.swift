...
final class AppsFlyerPluginTests: XCTestCase {
    ...
    // Same three cases as AppsFlyerPluginTest.kt's envelope-parity tests — keep in sync; proves both platforms emit an identical { success, data|error } shape despite differently-shaped raw input.
